...
public class BookController {
	...
	//metodo ou end point
	@Operation(summary = "Encontrar um livro especifico pelo seu ID")
	...
	public Book findBook(
		...
		book.setEnvironment("Book port: "+ port+ " Cambio port: "+ cambio.getEnvironment());//cambio.getEnvironment() pararecuperar porta
